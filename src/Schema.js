...
class Schema {
  ...
  constructor(schemaId, schemaOrSource) {
    this._id     = schemaId
    this._source = schemaOrSource.isSchema ? schemaOrSource.source : schemaOrSource
  }
  ...
  // TODO: Implement smart clone that would allow to embed and modify referenced
  //       schemas.
  clone(options = {}, schemaId = 'UNDEFINED_SCHEMA_ID') {
    ...
    if (options.skip) {
      for (let path of options.skip) {
        // TODO: This would work only with embeded specs, we can add exception
        //       to notify about bad usage until embeding referenced is
        //       implemented.
