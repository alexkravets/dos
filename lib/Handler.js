...
const Handler = (Operation) => class extends Operation {
  ...
  response() {
    ...
    // if (data) {
    //   this.result = meta ? { data, meta } : { data }
    // }

    // // TODO: Add comment on why this workaround is required here, I do not see
    // //       a reason right now why this would be required.
    // if (this.result) {
  ...
  async exec() {
    try {
      ...
      // TODO: We should probaly update this interface to error.
